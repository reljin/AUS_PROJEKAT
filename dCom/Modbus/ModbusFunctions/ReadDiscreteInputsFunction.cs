...
namespace Modbus.ModbusFunctions
{
    ...
    public class ReadDiscreteInputsFunction : ModbusFunction
    {
        ...
        {
            Dictionary<Tuple<PointType, ushort>, ushort> dictionnary = new Dictionary<Tuple<PointType, ushort>, ushort>();
            ...
            for (int i = 0; i < byteCount; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    ...
                    dictionnary.Add(new Tuple<PointType, ushort>(PointType.DIGITAL_INPUT, startAddress++), value);
